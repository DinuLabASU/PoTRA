...
## Rscript PoTRA_combN.R mydata.gene genelist.txt %Num_sample_normal% %Num_sample_case% %Pathway_database% %PR_quantile% Results_CombN.txt
...
## Rscript PoTRA_combN.R mydata.gene genelist.txt %Num_sample_normal% %Num_sample_case% %PR_quantile% Results_CombN.txt
